...
export default class Signup extends Component {
    ...
    saveUser(e) {
        ...
        UserDataService.create(user)
            ...
            .catch(e => {
                $('#response-text').addClass('text-danger').text("Server Error. Try again later");
                ...
                <div className="container">
                    <div className='row'>
                        <div className='col-md-10 offset-md-1'>
                            <form id='signup-form' name='signup-form' className="signup-form" onSubmit={this.saveUser.bind(this)}>
                                <div className='container'>    
